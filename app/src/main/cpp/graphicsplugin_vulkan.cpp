...
struct Swapchain {
    ...
    void Release() {
        ...
        if (hWnd) {
            DestroyWindow(hWnd);
            hWnd = nullptr;
            UnregisterClassW(L"xrdesk", hInst);
        }
#endif
...
// adjust the window size and show at InitDevice time
    ...
    hWnd = CreateWindowW(wc.lpszClassName, L"xrdesk (Vulkan)", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT,
...
#error CreateSurface not supported on this OS
        ...
        appInfo.pApplicationName = "xrdesk";
        appInfo.applicationVersion = 1;
        appInfo.pEngineName = "xrdesk";
